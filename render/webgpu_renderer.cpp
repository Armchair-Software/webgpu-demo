...
void webgpu_renderer::init() {
  ...
  logger << "render::window: Viewport size: " << window.css_viewport_size << " (nominal device pixels: approx " << window.css_viewport_size * window.device_pixel_ratio << ", framebuffer " << window.viewport_size << ")";
  logger << "render::window: CSS viewport size: " << window.css_viewport_size << " CSS pixels (framebuffer: " << window.viewport_size << " device pixels)";
  logger << "render::window: Device pixel ratio: " << window.device_pixel_ratio << " device pixels per CSS pixel (" << static_cast<unsigned int>(std::round(100.0 * window.device_pixel_ratio)) << "% scale)";
